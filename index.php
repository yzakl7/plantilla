...
<main id="content"> 
  <aside id="aside"><?php include './componentes/aside/aside.php';?></aside>
  <div class=" pagina active" id="planes-de-hospedaje-web" ><?php   include './paginas/planes-de-hospedaje-web/planes-de-hospedaje-web.html'; ?></div>
